                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="pelunasan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan pelunasan (-{{ $booking->kekurangan ?? 0 }})" required value="{{ $booking->kekurangan }}">
                            </div>
                            <div class="form-group">
